...
## [0.5.0](https://github.com/getong/RustQuant/compare/RustQuant_pricing-v0.4.0...RustQuant_pricing-v0.5.0) - 2026-03-28
...
- Update readme.
- Update README
- Compute returns in Polars `DataFrame` ([#37](https://github.com/getong/RustQuant/pull/37))
- Update readme.
- Update readme.
- Update README.md
- Update readme.
